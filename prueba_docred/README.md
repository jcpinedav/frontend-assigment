Aplicación web que se conecta a la API GraphQL de "Rick and Morty" y muestra los personajes de la serie en Cards, proporcionando una imagen y información de ellos(nombre, estatus, tipo y género).
